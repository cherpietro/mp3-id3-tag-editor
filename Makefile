OBJ= ID3v2.o ID3v2Header.o ID3v2Frames.o SizeReader.o COMMFrameList.o TextString.o PRIVFrameList.o FileFrameManager.o PrintFrameManager.o ListFramePtr.o
